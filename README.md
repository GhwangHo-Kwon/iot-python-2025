...
https://github.com/user-attachments/assets/e52e8630-f332-4fc1-ac3b-c0a786864d8b
...
- 파이썬 응용
    ...
    - 파이썬 GUI 라이브러리
        1. PyQt, PySide : 파이썬 최고의 GUI 라이브러리. Qt라는 C/C++ 사용할 GUI라이브러리를 Python용으로 변경
            ...
            - 코딩 다양성
            - 조금 어렵다(파이썬 코드와 분리가능)
            - Qt가 라이센스 구매필수, 프리웨어로 변경한게 PySide
        2. tikinter : 파이썬에 내장된 GUI 라이브러리.
            - 아주 단순. 학습이 쉬움
            - 파이썬 기본 내장
            - 안 이쁘다
